...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round((df[df["education"] == "Bachelors"].value_counts().sum() / df.shape[0]) * 100, 1)
    ...
    top_IN_occupation = df[df["native-country"] == "India"]["occupation"].value_counts(ascending = False).index[0]
